#
# Module manifest for module 'RDP-Forensic'
#
...
Description = 'A comprehensive PowerShell toolkit for RDP forensics analysis, tracking connection attempts, authentication, sessions, and logoffs across Windows Event Logs for security monitoring and incident response.'
...
FunctionsToExport = @()
# NOTE: ModuleBuilder will auto-populate this from source/Public/ during build
